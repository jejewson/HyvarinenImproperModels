...
Loading functions to set the priors and evaluate the Laplace approximations of the H-score.
...
Laplace approximation to the H-score for the Gaussian model.
...
Laplace approximation to the H-score for the Tukey's loss improper model under the non-local prior.
...
H-score (maximising) and SMIC (minimising) selection.
