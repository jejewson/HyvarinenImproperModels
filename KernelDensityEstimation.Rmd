...
Hyvarinen_GaussianKernelDensityEstimation_data_asymmetric <- list(n = n_obs, y = matrix(asymmetric_n_std, nrow = n_obs, ncol = 1), sig_p1 = a_0, sig_p2 = b_0, w = 1, sigma2_lower = n_obs^(-1/5)/100)
...
```{r Hyvarinen_GaussianKernelDensityEstimation_w_reparam_Optimising_asymmetric, include=TRUE,echo=TRUE, eval=TRUE,cache=TRUE}

Hyvarinen_GaussianKernelDensityEstimation_w_reparam_data_asymmetric <- list(n = n_obs, y = matrix(asymmetric_n_std, nrow = n_obs, ncol = 1), sig_p1 = a_0, sig_p2 = b_0, phi_p1 = 0, phi_p2 = 1, w = 1, sigma2_lower = n_obs^(-1/5)/100)

Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim <- optimizing(object = Hyvarinen_GaussianKernelDensityEstimation_w_reparam_stan, data = Hyvarinen_GaussianKernelDensityEstimation_w_reparam_data_asymmetric
, init = list("sigma2" = 0.1, "phi" = 0.1)
)

x_seq <- seq(-5, 5, length.out = 1000)
f_KDE_w_reparam_Gaussian_eval_asymmetric <- f_KDE_Gaussian_vect(x_seq, asymmetric_n_std, sigma2 = Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[1], w = 1 + Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[1] +  Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[2])


KDE_w_reparam_predictive_normaliser <- integrate(f = function(y){f_KDE_Gaussian_vect(y, asymmetric_n_std, sigma2 = Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[1], w = 1 + Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[1] +  Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[2])}, lower = -Inf, upper = Inf)
...
grad_log_f_hyv_KDE_w_reparam <-function(x){grad_log_f_KDE_Gaussian_vect(x, data = asymmetric_n_std, sigma2 = Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[1], w = 1 + Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[1] + Hyvarinen_GaussianKernelDensityEstimation_w_reparam_asymmetric_optim$par[2])}
...
points(x_seq, f_KDE_w_reparam_Gaussian_eval_asymmetric/KDE_w_reparam_predictive_normaliser$value, lwd = 3, type = "l", col = "purple")
...
FisherDivergences_asymmetric <- c(FisherDivergence_asymmetric_KDE$value, FisherDivergence_asymmetric_DPMM$value, FisherDivergence_asymmetric_hyv_KDE$value, FisherDivergence_asymmetric_hyv_KDE_w$value)
